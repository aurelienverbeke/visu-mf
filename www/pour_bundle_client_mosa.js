...
function mettre_profondeur_personnalise (event) {
	document.getElementById("selection-profondeur").value = "perso";
}

document.getElementById("selection-debut").addEventListener("input", mettre_profondeur_personnalise);
document.getElementById("selection-fin").addEventListener("input", mettre_profondeur_personnalise);

document.getElementById("selection-profondeur").addEventListener(
	"input",
	(event) => {
		let selecteur = document.getElementById("selection-profondeur");
		if(selecteur.value == "1" || selecteur.value == "2") {
			let nbImages = parseInt(selecteur.value) * 12;
			let nbImagesTotal = document.getElementsByClassName("heure").length;

			document.getElementById("selection-fin").selectedIndex = nbImagesTotal - 1;
			document.getElementById("selection-debut").selectedIndex = nbImagesTotal - nbImages;
		}
	}
);
...
derniereHeure.scrollIntoView(false);
